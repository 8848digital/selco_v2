...
def selco_sales_invoice_validate(doc,method):
	...
	for d in doc.get('items'):
		...
		d.commission_value_of_sales_person = round_based_on_smallest_currency_fraction((d.net_amount * flt(d.commission_rate_for_sales_person)) / 100, doc.currency)
		d.commission_value_of_sales_partner = round_based_on_smallest_currency_fraction((d.net_amount * flt(d.commission_rate_for_sales_partner)) / 100, doc.currency)
		d.value_of_budget = round_based_on_smallest_currency_fraction((d.net_amount * flt(d.commission_rate_for_budget)) / 100, doc.currency)
