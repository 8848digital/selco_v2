...
def get_maintenance_visit():
	...
	for row in data:
		...
		parent_dict['purposes'] = frappe.db.get_values("Maintenance Visit Purpose",{'parenttype':'Maintenance Visit','parent':row.name},child_fields, orber_by="idx",as_dict=True)
